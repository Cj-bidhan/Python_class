...
for key, value in students_marks.items():
    if value >=passing_threashold:
        passing_students.append(key) #till this line we have only stored the passed students in the list we created not priented them.
#now to print the list of passed students
print("List of students who have passed the exam: ")
for student in passing_students:
    print(f"Roll: {student}, Mark: {students_marks[student]}")
